            ...
            <div className="bg-card border border-border rounded-lg p-5 lg:col-span-2">
              ...
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={chartData}>
                  <XAxis dataKey="date" tick={{ fontSize: 10, fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif", fill: "#6B7280" }}
                    tickLine={false} axisLine={false} interval={11} />
                  <YAxis tick={{ fontSize: 10, fontFamily: "system-ui, -apple-system, Segoe UI, Roboto, Helvetica, Arial, sans-serif", fill: "#6B7280" }}
