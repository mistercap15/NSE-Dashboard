            ...
            <div className="bg-card border border-border rounded-lg p-5 lg:col-span-2">
              ...
              <ResponsiveContainer width="100%" height={220}>
                <LineChart data={chartData}>
                  <XAxis dataKey="date" tick={{ fontSize: 10, fontFamily: "ui-monospace, SFMono-Regular, Menlo, Consolas, monospace", fill: "#6B7280" }}
                    tickLine={false} axisLine={false} interval={11} />
                  <YAxis tick={{ fontSize: 10, fontFamily: "ui-monospace, SFMono-Regular, Menlo, Consolas, monospace", fill: "#6B7280" }}
